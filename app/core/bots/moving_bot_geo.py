# app/core/bots/moving_bot_geo.py
"""
...
Phase 14 (nationwide):
    ...
    Uses CBS locality dataset (``moving_bot_localities``) to resolve
...
def classify_route(addr_from: str, addr_to: str) -> RouteClassification:
    ...
    """
    from app.core.bots.moving_bot_localities import find_locality
